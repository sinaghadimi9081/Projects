...
string listall(Expression*&list,int size){
        string expression;
        string history;
...
string listbyoperator(Expression*&list,int size,char userOperator){
        string expression;
        string history="";
...
void listsummary(Expression*&list,int size){
    int sum=0;
    int reduction=0;
    int multiple=0;
    int division=0;
...
int main (){
    ...
    int left,right;
    char oper;
    Expression* list=new Expression[cap];
        ...
        if(option=="add"){
            ...
            if(cin.fail()){
                ...
                if(index%10==0){
                    int cap2=cap;
                    cap=cap+10;
                    Expression *temp=new Expression[cap];
            ...
            if (index==0){
                ...
                cin>>userOperator;
                cout<<listbyoperator(list,index,userOperator);
                cin.ignore(214748,'\n');
            }
            menu(); 
        }
